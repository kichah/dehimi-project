 ...
 * Original file: /npm/swiper@11.2.5/swiper.mjs
 *
...
var O = {
  ...
  updateSlides: function () {
    ...
    for (let i = 0; i < u; i += 1) {
      ...
      if (
        ...
        if ('auto' === s.slidesPerView) {
          ...
          (I = (n - (s.slidesPerView - 1) * x) / s.slidesPerView),
            s.roundLengths && (I = Math.floor(I)),
    ...
    if (
      ...
      s.setWrapperSize &&
        (i.style[e.getDirectionLabel('width')] = `${e.virtualSize + x}px`),
    ...
    return (
      0 === t
        ...
        : (n.setTransition(t),
          n.setTranslate(c),
          s &&
            (n.emit('beforeTransitionStart', t, r), n.emit('transitionStart')),
          n.animating ||
            ((n.animating = !0),
...
var G = {
  ...
  slideReset: function (e, t, s) {
    ...
    if (!i.destroyed)
      return (
        void 0 === e && (e = i.params.speed), i.slideTo(i.activeIndex, e, t, s)
      );
  },
...
var _ = {
  ...
  loopFix: function (e) {
    ...
    let M = 0,
      P = 0;
    const C = S ? Math.ceil(d.length / f.grid.rows) : d.length,
      ...
      if (T.length > 0 && E) {
        if (void 0 === t) {
          const e = l.slidesGrid[y],
            t = l.slidesGrid[y + M] - e;
          o
            ? l.setTranslate(l.translate - t)
            : (l.slideTo(y + Math.ceil(M), 0, !1, !0),
              r &&
        ...
        if (void 0 === t) {
          ...
          const e = S ? b.length / f.grid.rows : b.length;
          l.slideTo(l.activeIndex - e, 0, !1, !0);
        }
    if (
      ((l.allowSlidePrev = c),
...
function B(e) {
  ...
  const u = c.pageX,
    f = c.pageY;
  if (p.preventedByNestedSwiper) return (a.startX = u), void (a.startY = f);
  if (!s.allowTouchMove)
    return (
      p.target.matches(r.focusableElements) || (s.allowClick = !1),
      void (
        r.isTouched &&
        (Object.assign(a, { startX: u, startY: f, currentX: u, currentY: f }),
        (r.touchStartTime = o()))
      )
    );
        ...
        r.currentTranslate > s.minTranslate() &&
          ...
          n.resistance &&
            (r.currentTranslate =
              s.minTranslate() -
              1 +
              (-s.minTranslate() + r.startTranslate + v) ** y)))
      : v < 0 &&
        (S &&
          T &&
          r.allowThresholdMove &&
        ...
        r.currentTranslate < s.maxTranslate() &&
          ...
          n.resistance &&
            (r.currentTranslate =
              s.maxTranslate() +
              1 -
              (s.maxTranslate() - r.startTranslate - v) ** y))),
...
function N(e) {
  ...
  for (
    ...
    void 0 !== c[e + t]
      ? (m || (h >= c[e] && h < c[e + t])) && ((v = e), (g = c[e + t] - c[e]))
      : (m || h >= c[e]) && ((v = e), (g = c[c.length - 1] - c[c.length - 2]));
  }
  let w = null,
    S = null;
  n.rewind &&
  ...
  slidesPerViewDynamic(e, t) {
    ...
    if (s.centeredSlides) {
      ...
      for (let s = o + 1; s < i.length; s += 1)
        i[s] &&
          !e &&
          ((t += Math.ceil(i[s].swiperSlideSize)), (l += 1), t > a && (e = !0));
...
//# sourceMappingURL=/sm/a0aeae585c568c71541a1e889a2fe49b317531ac07943e1987ce306d1f0ad11c.map
